...
3. Activar la cuenta con código y comprobar que la verificación indique Código.
4. Crear otro trabajador y usar Activar manualmente.
5. Ingresar con la clave temporal y confirmar que solo permita cambiar la contraseña.
6. Esperar o modificar el vencimiento de prueba y confirmar que una clave temporal vencida sea rechazada.
7. Usar Renovar clave temporal y comprobar que la anterior deje de servir.
8. Desactivar al trabajador y confirmar el cierre de sus sesiones.
9. Usar Reactivar y confirmar que genere una nueva clave temporal.
10. Generar credenciales por código y comprobar que las anteriores dejen de servir.
11. Con SMTP configurado, confirmar que el correo se envía y las credenciales no se exponen en producción.
12. Fallar cinco accesos y comprobar bloqueo temporal.
13. Usar Desbloquear y confirmar que los intentos fallidos vuelvan a cero.
14. Confirmar que no sea posible desactivar la propia cuenta, la cuenta de recuperación ni el último administrador activo.
...
1. Abrir Inventario → Nuevo producto.
2. Intentar escribir más de 1000 en stock actual, mínimo, mensual y máximo por pedido.
3. Confirmar que el campo se limita a 1000.
